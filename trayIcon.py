...
class TrayIcon(QSystemTrayIcon):
    ...
    def other(self):
        ...
        #把鼠标点击弹出消息的信号和槽连接
        self.setIcon(QIcon("favicon.ico"))
    ...
    def showMsage(self,msg,millisecondsTimeoutHint = 10000):
        self.showMessage("提示", msg, self.icon,millisecondsTimeoutHint)
    def mClied(self):
